...
params.g.nRings= 106; params.g.nLayers= 2;
params.g.ringDist= 6*1e-3; params.g.layerSeparation= 4*1.082*1e-3;
  #%%params.g.bactProdMultiplier= 21;      % simulate a higher density, counteracting the spacing imposed above
...
params.viz.domLim= [[0;0],params.g.domainLim'./6];
