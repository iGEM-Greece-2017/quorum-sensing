...
% geometry
params.g.bactCenter0= 1e-3*[2.5,-1.082];
params.g.bactSize= 1e-3*[1,2.164];
params.g.nRings= 150; params.g.nLayers= 3;
...
params.viz.domLim= params.g.domainLim/3;
