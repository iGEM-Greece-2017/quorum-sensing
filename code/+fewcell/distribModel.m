...
% geometry
params.g.bactCenter0= 1e-3*[320,-1.082];
params.g.bactSize= 1e-3*[1,2.164];
params.g.nRings= 180; params.g.nLayers= 2;
...
params.growth.dr= 10;      % How many rings of bacteria to add at each growth step
params.growth.maxRings= 200;
